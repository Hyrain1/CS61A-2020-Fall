...
class Ant(Insect):
    ...
    def remove_from(self, place):
        ...
        Insect.remove_from(self, place) # self.place = None
...
# END Problem EC
    ...
    def action(self, gamestate):
        ...
        "*** YOUR CODE HERE ***"
        #true queen        
        if QueenAnt.true_queen is self:
            #throw
    ...
    def reduce_armor(self, amount):
        ...
        "*** YOUR CODE HERE ***"
        Ant.reduce_armor(self, amount)
        if QueenAnt.true_queen is self and \
            self.armor == 0:
            bees_win()
        # END Problem EC
    def remove_from(self, place):
...
class ContainerAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem Optional 2
        "*** YOUR CODE HERE ***"
        return not isinstance(other, ContainerAnt) and\
              not self.contained_ant
        # END Problem Optional 2
...
class LaserAnt(ThrowerAnt):
    ...
    def calculate_damage(self, distance):
        # BEGIN Problem Optional 5
        decrement = self.insects_shot * 0.05 + distance * 0.2
        if decrement >= 2:
            return 0
        else:
            return self.damage - decrement
        # END Problem Optional 5
